...
namespace MedReminder.Services
{
    public static class ResidentReportBuilder
    {
        ...
        public static string BuildHtml(ResidentReport report)
        {
            ...
            sb.AppendLine($"<div class='muted'>Generated: {ToLocalTime(report.GeneratedAt):yyyy-MM-dd HH:mm}</div>");
            ...
            else
            {
                ...
                {
                    sb.AppendLine("<tr>");
                    sb.AppendLine($"<td>{ToLocalTime(o.RecordedAt):yyyy-MM-dd HH:mm}</td>");
